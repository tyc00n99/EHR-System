        ...
        <div className="grid gap-4 lg:grid-cols-[300px_1fr]">
          ...
          <div className="space-y-4">
            <div className="grid gap-3 sm:grid-cols-3">
              ...
              <div className={cx("rounded-lg border bg-card px-4 py-3 shadow-[var(--shadow-sm)]", unsigned ? "border-danger/30" : "border-line")}><div className="text-[12.5px] font-medium text-muted-foreground">Unsigned visits</div><div className={cx("figure mt-1 text-[24px]", unsigned ? "text-danger" : "text-text-strong")}>{unsigned}</div><div className="text-[12.5px] text-muted-foreground">in the periods shown</div></div>
            </div>
