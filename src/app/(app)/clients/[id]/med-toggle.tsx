...
export function MedicationSupportToggle({ personId, on, manage }: { personId: string; on: boolean; manage: boolean }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 text-[13px]">
      ...
      <span className="flex-1 text-muted-foreground">{on ? "Staff administer or assist with medications for this person. The MAR is required." : "No medication support for this person. Turn it on if staff will administer or assist with medications."}</span>
