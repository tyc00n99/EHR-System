import { Card, PageHeader, Properties } from "@/components/ui";
      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_320px]">
        ...
        <div className="space-y-4">
          <Card title="Pay periods" padded>
            ...
            <p className="mt-3 text-xs text-muted">Biweekly, Sunday through Saturday. Ask your administrator to change this; it affects billing, payroll, and every dashboard.</p>
          </Card>
          <Card title="Data protection" padded>
            <ul className="space-y-1.5 text-[13px] text-muted"><li>Staff SSNs encrypted at rest (AES-256-GCM).</li><li>Every write to a client, staff, or visit record is audited with actor, before, and after.</li><li>Client files served only to assigned caregivers and office staff.</li><li>Sessions expire after 12 hours.</li></ul>
          </Card>
        </div>
      </div>
    </div>
