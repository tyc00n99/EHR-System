...
export const metadata = { title: "Manual visit entry" };
...
export default async function NewVisitPage() {
  ...
  return (
    <div>
      <PageHeader eyebrow={<><Crumb href="/visits">Visits</Crumb><CrumbSep /><Crumb>Manual entry</Crumb></>} title="Enter a visit manually" meta={<span>For visits not captured with a live clock-in. The reason travels with the visit to the aggregator.</span>} />
      <ManualVisitForm
