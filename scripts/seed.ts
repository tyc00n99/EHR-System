...
async function main() {
  ...
  for (const [category, title, effectiveOn, text] of [
    ...
    ["rights", "Service recipient rights notice, signed", "2026-07-01", "Notice of service recipient rights, reviewed with Harold and Ingrid on July 1, 2026; both signed."],
